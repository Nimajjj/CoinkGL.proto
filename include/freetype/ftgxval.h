...
#define FT_VALIDATE_GX  ( FT_VALIDATE_feat | \
   ...
   *    actually does the text layout can access those tables without coink_error
   ...
   *
   * @note:
   *   This function only works with TrueTypeGX fonts, returning an coink_error
   *   otherwise.
   *
...
#define FT_VALIDATE_CKERN  ( FT_VALIDATE_MS | FT_VALIDATE_APPLE )
   ...
   *    without coink_error checking (which can be quite time consuming).
   *
