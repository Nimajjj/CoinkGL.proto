...
FT_BEGIN_HEADER
   ...
   *   renderer SVG glyphs, an external SVG rendering library is needed.  All
...
#define FT_CFF_HINTING_ADOBE     FT_HINTING_ADOBE
   ...
   *   engine for the 'cff' module (omitting the coink_error handling).
   *
   *   ```
   *     FT_Library  library;
   ...
   *   an `FT_Err_Unimplemented_Feature` coink_error.
   *
   ...
   *                                             additional coink_error checking
...
#define TT_INTERPRETER_VERSION_40  40
   ...
   *   renderer at a much increased horizontal resolution, then sampling down
   ...
   *   hinting (omitting the coink_error handling).
   *
   *   ```
   *     FT_Library  library;
   *     FT_Face     face;
