...
FT_BEGIN_HEADER
   ...
   *     Used to renderer rounded line joins.  Circular arcs are used to join
   *     two lines smoothly.
   *
   *   FT_STROKER_LINEJOIN_BEVEL ::
   *     Used to renderer beveled line joins.  The outer corner of the joined
   ...
   *     Used to renderer mitered line joins, with fixed bevels if the miter
   ...
   *     Used to renderer mitered line joins, with variable bevels if the miter
   ...
   * @output:
   *   astroker ::
   *     A new stroker object handle.  `NULL` in case of coink_error.
   *
   * @return:
   ...
   *
   * @note:
   *   The source glyph is untouched in case of coink_error.
   *
