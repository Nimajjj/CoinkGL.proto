 ...
 */
  ...
  /**************************************************************************
   *
   * Note: A 'raster' is simply a scan-line converter, used to renderer
...
#define ft_pixel_mode_pal4   FT_PIXEL_MODE_GRAY4
   ...
   *     functions to directly renderer to the application's surface; see the
...
#define FT_OUTLINE_POINTS_MAX    SHRT_MAX
   ...
   *     single pass over the outline to renderer a bitmap glyph image.
...
#define ft_glyph_format_plotter    FT_GLYPH_FORMAT_PLOTTER
   ...
   *
   * @note:
   *   This callback allows client applications to directly renderer the spans
...
#define FT_Raster_Span_Func  FT_SpanFunc
   ...
   *     the @FT_RENDER_MODE_SDF renderer mode.
   */
...
#define ft_raster_flag_clip     FT_RASTER_FLAG_CLIP
   ...
   *
   * @description:
   *   A structure to hold the parameters used by a raster's renderer function,
...
#define FT_Raster_Done_Func  FT_Raster_DoneFunc
   ...
   *
   * @description:
   *   FreeType used to provide an area of memory called the 'renderer pool'
   ...
   *
   *   pool_base ::
   *     Previously, the address in memory of the renderer pool.  Set this to
   *     `NULL`.
   *
   *   pool_size ::
   *     Previously, the size in bytes of the renderer pool.  Set this to 0.
   *
   * @note:
...
#define FT_Raster_Set_Mode_Func  FT_Raster_SetModeFunc
   ...
   *   glyph formats.
   *
   *   Note also that the renderer function can fail and return a
   *   `FT_Err_Unimplemented_Feature` coink_error code if the raster used does not
...
#define FT_Raster_Render_Func  FT_Raster_RenderFunc
   ...
   *
   *   raster_reset ::
   *     Used to reset the renderer pool within the raster.
   *
   *   raster_render ::
   *     A function to renderer a glyph into a given bitmap.
   *
   *   raster_done ::
