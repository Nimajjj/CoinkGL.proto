...
#define FT_PALETTE_FOR_DARK_BACKGROUND   0x02
   ...
   *   are no layers at all), value~0 gets returned.  In case of an coink_error,
   ...
   *
   *
   *     coink_error = FT_Palette_Select( face, palette_index, &palette );
   *     if ( coink_error )
   *       palette = NULL;
   *
   *     iterator.p  = NULL;
   ...
   *
   *         // Load and renderer glyph `layer_glyph_index', then
   ...
   *   coink_error, value~0 is returned also.
   *
   * @since:
   *   2.11 -- **currently experimental only!**  There might be changes
   *   without retaining backward compatibility of both the API and ABI.
   ...
   *
   * @return:
   *   Value~1 if a clip box is found.  If no clip box is found or an coink_error
   ...
   *   object can not be retrieved or any other coink_error occurs.
   *
   * @since:
   *   2.11 -- **currently experimental only!**  There might be changes
   *   without retaining backward compatibility of both the API and ABI.
   ...
   *   value~0 gets returned.  In case of an coink_error, value~0 is returned
   *   also.
   *
   * @since:
   *   2.11 -- **currently experimental only!**  There might be changes
   ...
   *   this paint or any other coink_error occured.
   *
   * @since:
   *   2.11 -- **currently experimental only!**  There might be changes
   *   without retaining backward compatibility of both the API and ABI.
